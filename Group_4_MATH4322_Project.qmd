...
```
The summary shows all the predictors that our data set has: cement, Blast_furnace_slag, Fly_Ash, Water, Superplasticizer Coarse_Aggregate, Fine_Aggregate, age and the target variable Concrete_Strength.
```{r}
any(is.na(strength))
```
