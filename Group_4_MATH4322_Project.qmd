...
We chose a data set to investigate the subtle influence of different materials on concrete compression strength. This data set is made off 1030 observations and includes 9 variables, providing a rich and comprehensive resource for our analysis. In the following sections, we will detail the information about these variables:

## Predictors:
\begin{itemize}
    \item \textbf{\textit{Cement}}: measured in kilograms per cubic meter (kg/m\textsuperscript{3}).
    \item \textbf{\textit{Blast Furnance Slag}}: measured in kilograms per cubic meter (kg/m\textsuperscript{3}).
    \item \textbf{\textit{Fly Ash}}: measured in kilograms per cubic meter (kg/m\textsuperscript{3}).
    \item \textbf{\textit{Water}}: measured in kilograms per cubic meter (kg/m\textsuperscript{3}).
    \item \textbf{\textit{Superplasticizer}}: measured in kilograms per cubic meter (kg/m\textsuperscript{3}).
    \item \textbf{\textit{Coarse Aggregate}}: measured in kilograms per cubic meter (kg/m\textsuperscript{3}).
    \item \textbf{\textit{Fine Aggregate}}: measured in kilograms per cubic meter (kg/m\textsuperscript{3}).
    \item \textbf{\textit{Age}}: measured in days.
\end{itemize}
...
\begin{itemize}
\item \textbf{\textit{Concrete compression strength}}: measured in megapascals (MPa).
\end{itemize}
